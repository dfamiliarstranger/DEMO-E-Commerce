...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'demo-e-commerce-pwgp.onrender.com']
...
JAZZMIN_SETTINGS = {
    'site_title':'Market',
    'site_header':'Market Place',
    'site_brand':'market',
    'welcome_sign':"welcome to the market",
    'copyright':'dfamiliarstranger',
