    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('gid', shortuuid.django_fields.ShortUUIDField(alphabet='abcde1234', length=7, max_length=7, prefix='', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet=None, length=7, max_length=10, prefix='pdt', unique=True)),
                ('slug', models.SlugField(unique=True)),
